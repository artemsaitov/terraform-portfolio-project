...
resource "aws_s3_bucket" "nextjs_bucket" {
  bucket = "nextjs-portfolio-bucket-sas"
}
#Ownership Control
resource "aws_s3_bucket_ownership_controls" "nextjs_bucket_ownership_controls" {
 ...
 #Block Public Access 
resource "aws_s3_bucket_public_access_block" "nextjs_bucket_public_access" {
    bucket = aws_s3_bucket.nextjs_bucket.id
...
resource "aws_s3_bucket_acl" "nextjs_bucket_acl" {
 depends_on = [
  ...
  aws_s3_bucket_public_access_block.nextjs_bucket_public_access
]
